...
env = UnityEnvironment(file_name='pyramid_linux/pyramid_16')
...
while True:
    ...
    writer.add_scalar('data/combine_reward_per_rollout', np.sum(total_combine_reward) / num_worker, global_update)
