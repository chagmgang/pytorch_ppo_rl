...
def main():
    ...
    while True:
        ...
        int_target, int_adv = make_train_data_icm(total_int_reward,
        ...
        int_adv = (int_adv - np.mean(int_adv)) / (np.std(int_adv) + 1e-8)

        target = int_target * 0 + ext_target * 1.0
        adv = int_adv * 0 + ext_adv * 1.0
        # -----------------------------------------------
